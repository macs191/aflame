    ...
    <header className="sticky top-0 z-40 bg-dark-900/90 backdrop-blur-md border-b border-gold-500/20 px-4 sm:px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          {user ? <Link to="/profile" className="flex items-center gap-2 bg-dark-800 border border-gold-500/30 px-3 sm:px-4 py-2 rounded-xl text-sm text-gold-400 font-bold"><User className="w-4 h-4" /><span className="hidden sm:inline">حسابي</span></Link> : <Link to="/login" className="flex items-center gap-2 text-sm text-gray-300 hover:text-gold-400"><LogIn className="w-4 h-4" /><span className="hidden sm:inline">دخول</span></Link>}
